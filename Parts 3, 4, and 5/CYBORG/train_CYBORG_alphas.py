...
# C:\Users\byron\OneDrive\Documents\Python Stuff\Computer Vision\Driving_Project\Combined\003862_2.jpg
...
parser.add_argument('-alpha_cyborg', required=False, default=0.5,type=float)
...
# parser.add_argument('-alpha_xent', required=False, default=0.5,type=float)
...
parser.add_argument('-lr',required=False, default=.25, type=float)
